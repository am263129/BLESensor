        ...
        implements  FragmentCompat.OnRequestPermissionsResultCallback
{
    ...
    public static int EMIT_START_RECORDING = 0;
    public static int EMIT_STOP_RECORDING = 1;

    private static Camera2VideoFragment self;
    ...
    public Handler cameraControlHandler = new Handler(){
        @Override
        public void handleMessage(@NonNull Message msg) {
            super.handleMessage(msg);
            if(msg.what == EMIT_START_RECORDING){
                mNextVideoAbsolutePath = Util.getMp4FilePath();
                startRecordingVideo();
            }
            else if(msg.what == EMIT_STOP_RECORDING){
                stopRecordingVideo();
            }
        }
    };
    ...
    {
        self = new Camera2VideoFragment();
        return self;
    }

    public static Camera2VideoFragment getInstance() {
        return self;
    }
    /**
...
//        view.findViewById(R.id.info).setOnClickListener(this);
    ...
    private void setUpMediaRecorder() throws IOException
    {
        ...
        mMediaRecorder.setAudioEncodingBitRate(170000);
